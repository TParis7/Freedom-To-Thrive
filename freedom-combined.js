...
/* Top-align Youth Career Accelerator (alt) photo on desktop so the group shot reads from the top. */
#ft-root .platform-card.alt .fc-vis img { object-position: center top; }
...
@media (max-width: 768px) {
  ...
  #ft-root .platform-card .fc-vis { height: 200px; }
  #ft-root .platform-card.alt .fc-vis img { object-position: center center; }
  ...
  #ft-root .why-card { padding: 24px 22px; text-align: center; }
  #ft-root .why-card-icon { width: 44px; height: 44px; margin: 0 auto 14px; }
  ...
  #ft-root .partner-card { padding: 22px 20px; text-align: center; }
  #ft-root .partner-card .partner-arrow { margin: 0 auto 14px; }
...
<section class="hero">
  ...
  <div class="hero-content">
    <div class="hero-badge"><span class="pulse"></span> July 4, 2026 &middot; Chicago</div>
    <h1>Freedom to Thrive<span class="line2">A July 4th Experience</span></h1>
    <p class="hero-sub">Presented by <strong>The Fibroid Slayer</strong> in partnership with <strong>The Pulse of Perseverance Project (P3)</strong> &mdash; a curated day-party experience uniting culture, community, and purpose.</p>
    <div class="hero-meta">
      <span>
...
<section class="sponsors" id="sponsors">
  <div class="section-inner">
    ...
    <p class="section-subtitle">Four ways to align your brand with culture, health, and community.</p>
